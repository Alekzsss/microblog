...
from appz import db
from appz.main.forms import EditProfileForm, PostForm, SearchForm, MessageForm
from flask_login import current_user, login_required
from appz.models import User, Post, Message, Notification, Permission
from datetime import datetime
from flask_babelex import _, get_locale
from guess_language import guess_language
from appz.translate import translate
from appz.main import bp
...
def index():
    ...
    if form.validate_on_submit():
        language = guess_lang(form.post.data)
...
def edit_post(id):
    ...
    if form.validate_on_submit():
        ...
        post.language = guess_lang(form.post.data)
        db.session.add(post)
        db.session.commit()
        form.post.data = ''
        page = request.args.get('page', 1, type=int)
    ...
    return render_template('edit_post.html', title='edit_post', form=form)
